...
\setbeamercolor{section in head/foot}{bg=smart-blue, fg=nus-white}
\setbeamercolor{subsection in head/foot}{bg=smart-blue, fg=nus-white}
\setbeamercolor{frametitle}{bg=smart-red, fg=nus-black}
\setbeamercolor{title}{bg=smart-blue, fg=nus-white}
\setbeamercolor{alerted text}{fg=nus-orange}
\setbeamercolor{block title}{fg=smart-blue}
...
{\transparent{0.2}\includegraphics[width=\paperwidth,height=\paperheight]{firstpage.jpeg}}
